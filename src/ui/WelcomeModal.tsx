...
export const WelcomeModal: FC<WelcomeModalProps> = ({ isOpen, onClose }) => (
  <Dialog
    ...
    onClose={onClose}
    open={isOpen}
    title="Welcome to Your Band Companion!"
  >
    <div className="mb-6 space-y-4 text-sm text-slate-300">
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400">
              Organize songs into sets for your gigs. Track what you've played and what's coming up
              next.
            </p>
          </div>
        </div>
      ...
      <p className="pt-2">
        Start by adding some songs to your library or creating your first setlist. All your data is
