...
// CSS color palettes in OKLCH format
const colorPalettes: Record<BrandColor, Record<string, string>> = {
  amber: {
...
export const BRAND_COLOR: BrandColor = 'emerald';

/**
 * Get the CSS theme string to insert into index.css
 * Call this when you want to switch themes
 */
export function getThemeCSSVariables(color: BrandColor): string {
  const palette = colorPalettes[color];
  return Object.entries(palette)
    .map(([shade, oklch]) => `--color-brand-${shade}: ${oklch};`)
    .join('\n  ');
}
