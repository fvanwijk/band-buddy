    ...
    <div className="space-y-3">
      ...
      {showBulkInput && (
        <div className="space-y-3 rounded-lg border border-slate-700 bg-slate-800/50 p-4">
          ...
          <textarea
            className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-100 placeholder-slate-500 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-400/20"
